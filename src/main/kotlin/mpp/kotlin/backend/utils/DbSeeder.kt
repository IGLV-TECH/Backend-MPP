...
class DbSeeder(
    ...
    override fun run(vararg args: String?) {
        ...
        val item11 = Item("PAPER_AND_CARDBOARD1",0F, CategoryType.valueOf("PAPER_AND_CARDBOARD"))
        val item12 = Item("PAPER_AND_CARDBOARD2",0F, CategoryType.valueOf("PAPER_AND_CARDBOARD"))
        val item13 = Item("PAPER_AND_CARDBOARD3",0F, CategoryType.valueOf("PAPER_AND_CARDBOARD"))
        val item14 = Item("PAPER_AND_CARDBOARD4",0F, CategoryType.valueOf("PAPER_AND_CARDBOARD"))
        val item15 = Item("PAPER_AND_CARDBOARD5",0F, CategoryType.valueOf("PAPER_AND_CARDBOARD"))
        val item21 = Item("PLASTIC_AND_BOTTLE1",0F, CategoryType.valueOf("PLASTIC_AND_BOTTLE"))
        val item22 = Item("PLASTIC_AND_BOTTLE2",0F, CategoryType.valueOf("PLASTIC_AND_BOTTLE"))
        val item23 = Item("PLASTIC_AND_BOTTLE3",0F, CategoryType.valueOf("PLASTIC_AND_BOTTLE"))
        val item24 = Item("PLASTIC_AND_BOTTLE4",0F, CategoryType.valueOf("PLASTIC_AND_BOTTLE"))
        val item25 = Item("PLASTIC_AND_BOTTLE5",0F, CategoryType.valueOf("PLASTIC_AND_BOTTLE"))
        val item31 = Item("METAL_AND_ALUMINIUM1",0F, CategoryType.valueOf("METAL_AND_ALUMINIUM"))
        val item32 = Item("METAL_AND_ALUMINIUM2",0F, CategoryType.valueOf("METAL_AND_ALUMINIUM"))
        val item33 = Item("METAL_AND_ALUMINIUM3",0F, CategoryType.valueOf("METAL_AND_ALUMINIUM"))
        val item34 = Item("METAL_AND_ALUMINIUM4",0F, CategoryType.valueOf("METAL_AND_ALUMINIUM"))
        val item35 = Item("METAL_AND_ALUMINIUM5",0F, CategoryType.valueOf("METAL_AND_ALUMINIUM"))
        val item41 = Item("ELECTRIC_AND_ELECTRONICS1",0F, CategoryType.valueOf("METAL_AND_ALUMINIUM"))
        val item42 = Item("ELECTRIC_AND_ELECTRONICS2",0F, CategoryType.valueOf("METAL_AND_ALUMINIUM"))
        val item43 = Item("ELECTRIC_AND_ELECTRONICS3",0F, CategoryType.valueOf("METAL_AND_ALUMINIUM"))
        val item44 = Item("ELECTRIC_AND_ELECTRONICS4",0F, CategoryType.valueOf("METAL_AND_ALUMINIUM"))
        val item45 = Item("ELECTRIC_AND_ELECTRONICS5",0F, CategoryType.valueOf("METAL_AND_ALUMINIUM"))
